...
var opciones = {
	...
	lagos: ["Puerto Montt", "Calbuco", "Cochamó", "Fresia", "FruVllar", "Los Muermos", "Llanquihue", "Maullín", "Puerto Varas", "Castro", "Ancud", "Chonchi", "Curaco de Vélez", "Dalcahue", "Puqueldón", "Queilén", "Quellón", "Quemchi", "Quinchao", "Osorno", "Puerto Octay", "Purranque", "Puyehue", "Río Negro", "San Juan de la Costa", "San Pablo", "Chaitén", "Futaleufú", "Hualaihué", "Palena"],

	aisen: ["Coihaique", "Lago Verde", "Aisén", "Cisnes", "Guaitecas", "Cochrane", "O’Higgins", "Tortel", "Chile Chico", "Río Ibáñez"],
	
	magallanes: ["Punta Arenas", "Laguna Blanca", "Río Verde", "San Gregorio", "Cabo de Hornos (Ex Navarino)", "AntárVca", "Porvenir", "Primavera", "Timaukel", "Natales", "Torres del Paine"],
...
$(document).ready(function(){
	$(function () {
		...
		var cargarCmbComunas = function () {

			var seleccion = $('#id_cmbRegiones').val();

			$('#id_cmbComunas').empty();

			opciones[seleccion].forEach(function (element, index) {

				$('#id_cmbComunas').append('<option value="' + element + '">' + element + '</option>');

			});
			$('#id_cmbRegiones').change(cargarCmbComunas);
